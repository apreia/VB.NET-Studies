Public Class Frm_TelaPrincipal_03
    ...
    Public Sub New()
        ...
        Text = "Aplicação Manipulando Textos!"
    ...
    Private Sub Btm_Principal_Click(sender As Object, e As EventArgs) Handles Btm_Principal.Click
        ...
        MsgBox("O caracter da variável PrimeiraLetra é " + SegundaLetra)
        ...
        MsgBox("O caracter da variável PrimeiraLetra é " + TerceiraLetra + " e o 66 é " + QuartaLetra)
    End Sub
